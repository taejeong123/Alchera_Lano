...
class MainWindow(QMainWindow, Ui_MainWindow):
    def __init__(self):
        ...
        self.pushButton_load_file.clicked.connect(
            ...
            lambda: self.lineEdit_path2file.setText(QFileDialog.getExistingDirectory(
                self, "Set Input directory", "./")))
    ...
    def start_download(self):
        ...
        for root, dirs, files in os.walk(keywords_list, topdown=False):
            for file_ in files:
                ...
                for index in range(num_keywords):
                    ...
                    str_paras = config.to_command_paras(os.path.splitext(file_)[0])
